...
public class Cpu {
   ...
   private JdbcTemplate con = conexao.getConexaoBanco();
    ...
    public void capturarDadosCpu(){
        ...
        con.update("INSERT INTO Cpu (frequencia, numeroCpuFisica, numeroCpuLogica, numeroPacote, usoDeCpu," +
                        "tempoCapturas, fkCodHardware, fkMaquina) values (?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP, ?, ?)",
                frequencia, numeroCpuFisica, numeroCpuLogica, numeroPacote, usoDeCpu, fkCodHardware, fkMaquina);
    }
